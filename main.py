"""
Interface  (planning.md — Stage 5)

Launches the Gradio web UI for the Drexel Panhellenic Unofficial Guide.
...
with gr.Blocks(title="Drexel PHC Unofficial Guide") as demo:
    ...
    gr.Markdown(
        "Ask anything about sorority recruitment at Drexel. "
        "Answers come from GreekRank, Reddit, and official Drexel PHC sources only."
    )

    inp = gr.Textbox(
        label="Your question",
        placeholder="e.g. What is it like to rush Delta Zeta?",
    )
    btn = gr.Button("Ask")
